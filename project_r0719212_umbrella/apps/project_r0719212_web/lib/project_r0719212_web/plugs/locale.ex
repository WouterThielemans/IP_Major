defmodule ProjectR0719212Web.Plugs.Locale do
    import Plug.Conn
  
    @locales Gettext.known_locales(ProjectR0719212Web.Gettext)
    ...
    def call(conn, _options) do
      case fetch_locale_from(conn) do
        ...
        locale ->
            ProjectR0719212Web.Gettext |> Gettext.put_locale(locale)
